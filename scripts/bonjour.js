...
const N8N_WEBHOOK_BONJOUR = process.env.N8N_WEBHOOK_BONJOUR;   // e.g. "https://.../webhook/discord-trigger"

if (!TOKEN || !BOT_ID || !N8N_WEBHOOK_BONJOUR) {
...
client.on(Events.MessageCreate, async (msg) => {
  try {
    ...
    // POST to n8n
    await axios.post(N8N_WEBHOOK_BONJOUR, payload, {
      timeout: 10000,
